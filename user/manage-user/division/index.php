                ...
                <div class="box-manage-user">
                  <?php  
                    ...
                    if (isset($_GET['action']) && $_GET['action'] == 'create-new') {
                        ...
                        include_once('../template/create-division.php');

                    } elseif (isset($_GET['action']) && $_GET['action'] == 'edit' && isset($_GET['id'])) {

                        include_once('../template/edit-division.php');

                    } elseif (isset($_GET['detail'])) {

                        include_once('../template/detail-division.php');

                    } elseif (isset($_GET['search_name'])) {

                        include_once('../template/search-data-division.php');

                    } else {
 
                    	include_once('../template/table-data-division.php');
